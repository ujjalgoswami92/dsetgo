...
?>
<?php
function sendmail($cemailid1,$message)
{
...
echo 'Unable to send email. Please try again.';
 ...
 $cFlatnoSociety=$row["cFlatno_Society"];
...
if($_POST["additem"])
 {
   ...
   $cfirstname1=$_POST["cfirstname"];
   $clastname1=$_POST["clastname"];
   $cemailid1=$_POST["cemailid"];

  //  $cFlatnoSociety1=htmlentities($_POST['cFlatnoSociety']);
  //  echo $cFlatnoSociety1;

   $caddress1="Gurgaon Nirvana Country  ".$cFlatnoSociety1;
   $cregpickdate= $_POST["cregpickdate"];
   $cregdropdate=$_POST["cregdropdate"];
   //$cregdropdate=date('m-d-Y',strtotime($cregpickdate,"+1 days"));
   $max=$_POST["total"];
   $sum=0;
   $flag=0;
   for($i=1;$i<=$max;$i++)
 ...
 if($flag==1)
 {
       ...
       $sql = "INSERT INTO dsetgo_orders (orderid,oamount,cid,ocfirstname,oclastname,ocemailid,ocaddress,orderstatus,regpickdate,regdropdate,regpicktime,regdroptime)
       VALUES ('$orderid','$sum', '$cid','$cfirstname1','$clastname1','$cemailid1','$caddress1','pending','$cregpickdate','$cregdropdate','8pm to 10pm','8pm to 10pm')";
         ...
         <table cellspacing='0' cellpadding='0' border='0' width='100%'>
           <tbody><tr>
             <td align='center' valign='top' style='padding:20px 0 20px 0'><table bgcolor='#FFFFFF' cellspacing='0' cellpadding='10' border='0' width='650' style='border:1px solid #e0e0e0'>
                 ...
                 <tr>
                   <td valign='top'><h1 style='font-size:22px;font-weight:normal;line-height:22px;margin:0 0 11px 0'>Hello, $cfirstname1  $clastname1 </h1>
...
$i=1;
    ...
    $i=$i+1;
         ...
         <form  action='' method='post' >
            <div class='lable'>
             <div class='col_1_of_1 span_1_of_3'><input type='text'  name='cfirstname' placeholder='FirstName'  value=$cfirstname>
            </div>
            </div>
            <div class='lable'>
              <div class='col_1_of_1 span_1_of_3'>	<input type='text'  name='clastname' placeholder='LastName'   value=$clastname>
         </div>
            </div>
            <div class='lable'>
              <div class='col_1_of_1 span_1_of_3'>	<input type='text' readonly name='ccity' placeholder='Gurgaon'   value='Gurgaon'>
         </div>
            </div>

            <div class='lable'>
              <div class='col_1_of_1 span_1_of_3'>	<input type='text'  readonly name='carea' placeholder='Nirvana Country, Sector 50'   value='Nirvana Country'>
         </div>
            </div>

            <div class='lable'>
              <div class='col_1_of_1 span_1_of_3'>	<textarea rows='3' cols='89'  name='cFlatnoSociety' >$cFlatnoSociety</textarea>
          </div>
            </div>

                  <div class='lable'>
             <div class='col_1_of_1 span_1_of_3'>	<input type='text'  name='cemailid' placeholder='Email id'   value=$cemailid>
         </div>
            </div>
            <div class='lable'>
            ...
            <div class='lable'>
              <div class='col_1_of_1 span_1_of_3'> PICK UP	<input type='date' name='cregpickdate' data-date-format='dd/mm/yyyy' />
           </div>
            </div>
            <div class='lable'>
              <div class='col_1_of_1 span_1_of_3'>DROP	<input type='date' name='cregdropdate' data-date-format='dd/mm/yyyy' />
           </div>
            </div>
