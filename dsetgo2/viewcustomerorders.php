...
$cid=$_GET["id"];
           $sql2 = "SELECT * FROM dsetgo_orders where cid=$cid";
           $result = $conn->query($sql2);
           $dynamicList1="<table ><tr ><td>OrderID</td><td>OrderAmount</td><td>Products</td></tr>";
  ...
  $dynamicList .='<tr><td >'. $row["orderid"].'</td><td >'. $row["oamount"].'</td><td >'. $row["products"].'</td></tr>';
